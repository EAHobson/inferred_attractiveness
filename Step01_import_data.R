...
# IMPORT DATA
#------------------------------------------------------
# download zip file of raw Mathematica output from https://osf.io/vfcph
# make two new folders: "Model output" and within that folder, another folder called "runs to analyze"
# unzip downloaded data and save to "Model output/runs to analyze"
