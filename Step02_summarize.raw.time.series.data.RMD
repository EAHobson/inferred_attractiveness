...
In this version (Hb) I fixed the counting of the number of streaks (was only reporting 1/NA rather than actual length/number of streaks) and re-ran the entire loop with all model variants

Script updated for new runs in Aug 2022 and all new compiled data from the re-runs were used.
