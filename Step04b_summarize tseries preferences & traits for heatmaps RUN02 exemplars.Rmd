...
Goal: summarize across replicated timeseries' (20 replicates per model variant, per s/a combination)

* Note: median number of shifts for all runs (with circuits and also without, including 0 shifts)
