...
This script is Step 5b of the analysis/plotting scripts. 

We used a slight variation of the script in Step05a to now plot Figure S2 for the Supplemental Materials.
...
#Import data
```{r}
rank.path <- "Model output/Rank figure output/For Fig S2/30/"


rankN30 <- read_csv("Model output/Rank figure output/For Fig S2/30/Ranks_group30.SUPPMAT.compiled.csv")
glimpse(rankN30)
...
pdf(paste("Plots_summarized data/rankplots_N30_gen100_SUPPMAT", "pdf", sep="."), width=8, height=3, onefile = TRUE)
